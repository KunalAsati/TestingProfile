...
import uploadFileToDriveItem from '@salesforce/apex/GraphAPIControllerLargeFile.uploadFileToDriveItem';
import {ShowToastEvent} from 'lightning/platformShowToastEvent';
import readCSVFile from '@salesforce/apex/GraphAPIControllerLargeFile.readCSVFile';

const columns = [
    { label: 'Id', fieldName: 'Id' }, 
    { label: 'Name', fieldName: 'Name' }
];
export default class GraphApiLargeFile extends LightningElement {
